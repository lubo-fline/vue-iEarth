      ...
      <div class="sm-function-module-content">
        ...
        <div class="sm-function-module-sub-section" v-if="scanMode=='lineMode'">
          ...
          <select class="sm-select" v-model="lineScanTexture">
            ...
            <option value="static/images/ParticleSystem/线状扫描纹理1.jpg">{{Resource.LinearTexture1}}</option>
            <option value="static/images/ParticleSystem/线状扫描纹理2.jpg">{{Resource.LinearTexture2}}</option>
          </select>
        </div>
        <div class="sm-function-module-sub-section" v-if="scanMode=='ringMode'">
          ...
          <select class="sm-select" v-model="circleScanTexture">
            <option value="none-texture">{{No}}</option>
            <option value="static/images/ParticleSystem/环状扫描纹理1.jpg">{{Resource.CircularTexture1}}</option>
            <option value="static/images/ParticleSystem/环状扫描纹理2.jpg">{{Resource.CircularTexture1}}</option>
