  ...
  >
    <div class="sm-content">
      <div class="sm-panel-header">
        <span :class="{titleColor:addPoint}" class="title-txt" @click="choose(0)">{{Resource.AddPoint}}</span>
        <span :class="{titleColor:addPolyline}" class="title-txt" @click="choose(1)">{{Resource.AddLine}}</span>
        <span :class="{titleColor:addPolygon}" class="title-txt" @click="choose(2)">{{Resource.AddFaces}}</span>
